import { router, useFocusEffect, useLocalSearchParams } from "expo-router"; // Sử dụng useRouter thay vì navigation pop
...
function PaymentDetail() {
  ...
  React.useEffect(() => {
    ...
    return () => {
      ...
      if (parsedBookingInfo.cartItemId && wsCart && wsCart.readyState === WebSocket.OPEN) {
        wsCart.send(
          JSON.stringify({
            type: "outPayment",
            itemId: parsedBookingInfo.cartItemId,
