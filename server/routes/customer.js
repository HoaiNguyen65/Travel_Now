...
router.post("/send-registration-otp", accountsController.sendRegistrationOTP);
router.post("/verify-registration", accountsController.verifyRegistrationOTP);
router.post("/resend-otp", accountsController.resendOTP);
router.post("/verify-email-otp", accountsController.verifyEmailOTP);
router.post("/check-email", accountsController.checkEmail);
